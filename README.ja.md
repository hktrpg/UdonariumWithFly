...
| 手札・本物の山札 | 下部直列 tuck 手札（hover 展開、表／裏出し）；山札から手札へドロー／配り；表紙側から抽かつ表裏保持；F＝山ごと裏返し；ロックで移動／ドロー不可；Hover 名→text；Ctrl／⌘ 大画像プレビュー（ピン、ダブルクリックで詳細）；裏向きはプレイヤーに詳細を開かない |
...
| 卓の照明と視界 | 暗闇と環境光を分離／FoW、ライト、壁、視界距離；視界キャラを申告可能 |
