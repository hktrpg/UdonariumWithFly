...
| 手牌庫・真實牌堆 | 底部直排 tuck 手牌（hover 展開、打出可選正／背）；牌堆抽入手牌／派牌；永遠從封面抽且保留朝向；F＝整疊翻轉；鎖定禁拖／禁抽；Hover 名→text；Ctrl／⌘ 物件大圖預覽（可釘、雙擊開詳情）；反面對玩家不開詳情 |
...
| 桌面光照與視野 | 黑暗／環境光分開、FoW、燈光、牆、視野距離；可宣告視野角色 |
