...
export const zhCN_ctx: I18nDictionary = {
  ...
  'char.tokenSettings': 'TOKEN 设定', 'char.appearanceFx': '外观／特效', 'char.cloneAutoNumberOn': '☑ 自动编号', 'char.cloneAutoNumberOff': '☐ 自动编号', 'char.stackOn': '☑ 可叠在其他角色上', 'char.stackOff': '☐ 可叠在其他角色上', 'char.altitudeOn': '☑ 显示高度', 'char.altitudeOff': '☐ 显示高度', 'char.pitch': '仰角（招牌感）', 'char.pitchTip': 'Ctrl+Alt+Shift+滚轮微调（Alt+Shift 仍为左右倾 roll）。R 重置。', 'char.resetAltitude': '将高度设为0',
