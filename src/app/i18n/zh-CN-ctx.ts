...
export const zhCN_ctx: I18nDictionary = {
  ...
  'char.resetAltitudeAll': '全部将高度设为0', 'char.selectedCount': '已选择 {{count}} 个角色', 'char.inventoryAllOn': '全部在桌面仓库显示', 'char.inventoryAllOff': '全部不在桌面仓库显示', 'char.cloneAll': '全部建立副本', 'char.deleteAllToGraveyard': '全部删除（移至回收区）', 'char.clearSelection': '取消选择',
  ...
  'fx.tokenFrame': 'Token 外框', 'fx.tokenFrame.none': '无', 'fx.tokenFrame.polaroid': '拍立得', 'fx.tokenFrame.photo': '照片', 'fx.tokenFrame.card': '卡牌',
  'fx.pushPin': '图钉', 'fx.pushPin.on': '☑ 显示图钉', 'fx.pushPin.off': '☐ 显示图钉', 'fx.pushPin.reangle': '随机图钉角度', 'fx.pushPin.red': '红', 'fx.pushPin.white': '白', 'fx.pushPin.yellow': '黄', 'fx.pushPin.green': '绿',
