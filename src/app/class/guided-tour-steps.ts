...
export function buildGuidedTourSteps(isMobile = false): GuidedTourStep[] {
  ...
  return [
    ...
    menuOpen('timer', 'menu.timer', 'panel-open', { skipIfGuest: true }),
    ...
    {
      id: 'handRail',
      titleKey: 'tour.step.handRail.title',
      bodyKey: 'tour.step.handRail.body',
      bodyKeyMobile: 'tour.step.handRail.bodyMobile',
      target: '[data-tour-id="hand.rail"]',
      require: 'ack',
      chapter: 'controls',
      skipIfGuest: true,
    },
...
function buildMobileGuidedTourSteps(): GuidedTourStep[] {
  return [
    ...
    {
      id: 'timerMobile',
      titleKey: 'tour.step.timer.title',
      bodyKey: 'tour.step.timer.bodyMobile',
      target: '[data-tour-id="menu.more"]',
      tourId: 'menu.more',
      require: 'ack',
      chapter: 'menu',
      skipIfGuest: true,
    ...
    },
    {
      id: 'handRail',
      titleKey: 'tour.step.handRail.title',
      bodyKey: 'tour.step.handRail.bodyMobile',
      target: '[data-tour-id="hand.rail"]',
      require: 'ack',
      chapter: 'controls',
      skipIfGuest: true,
